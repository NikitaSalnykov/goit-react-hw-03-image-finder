    ...
    render() {
      ...
      return (
        <AppContainer>
          ...
          {isLoading && <Loader/>}
          {notFoundText ? <p>No results found for '{value}'</p> : <ImageGallery gallery={gallery} showModal={showModal}/>}
          {loadMore && <Button onClick={handleLoadMore} children='Load more' />}
          {ModalActive && <Modal largeImgObj={largeImgObj} closeModal={closeModal} />}
        </AppContainer>
      )
    }
  }